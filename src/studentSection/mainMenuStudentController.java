 ...
 */
public class mainMenuStudentController implements Initializable {
...
//        Parent root = FXMLLoader.load(getClass().getResource("/teacherection/mainMenuTeacher.fxml"));
//
//        Node node = (Node) event.getSource();
//        Stage stage = (Stage) node.getScene().getWindow();
//        stage.setScene(new Scene(root));
    ...
    private void onMouseClickUpdate(MouseEvent event) throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/studentSection/updateStudent.fxml"));
    ...
    private void onMouseClickDelete(MouseEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/studentSection/deleteStudent.fxml"));
    ...
    private void onMouseClickView(MouseEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/studentSection/viewStudent.fxml"));
